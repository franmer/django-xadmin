...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Introduce " + n + " caracter" + (n == 1? "" : "es") + " más"; },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Borra " + n + " carácter" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "Solo puedes seleccionar " + limit + " item" + (limit == 1 ? "" : "s"); },
